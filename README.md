...
```
  ...
  * Ansible requires the Docker Python client to control Docker Containers.  In the next step the playbook will specify the installation of this Docker Python module.
...
![Creating the Network Environment](https://github.com/oxa111/Cybersecurity-Portfolio/blob/75eebd6b066065bcd712940b62694c8f13951f25/Creating%20the%20Virtual%20Network%20Environment.pdf)
